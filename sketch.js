...
function setup(){
  ...
  solo.x = solo.width/2;
  soloInvisivel = createSprite(200,195,800,10);
  ...
  botao_restart = createSprite(300,140,10,10);
  botao_restart.visible = false;
  botao_restart.addImage(restart);
  botao_restart.scale = 0.7;
  
  botao_gameOver = createSprite(300,100,10,10);
...
function draw(){
  ...
  text("pontuacao: "+ pontuacao,500,30);
...
function gerarNuvens(){
  ...
  nuvem = createSprite(600,Math.round(random(50,150)),50,10);
  //velocidade da nuvem
  nuvem.velocityX = -3;
